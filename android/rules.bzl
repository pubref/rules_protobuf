# Reuse the java deps file rather than copying to a redundant file.
...
def android_proto_repositories(
    lang_deps = DEPS,
    lang_requires = [
...
def android_proto_compile(langs = [str(Label("//android"))], **kwargs):
  proto_compile(langs = langs, **kwargs)

def android_proto_library(
    name,
    langs = [str(Label("//android"))],
    protos = [],
    imports = [],
    inputs = [],
