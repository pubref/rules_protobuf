...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    deps = [
        "@raze__aho_corasick__0_6_4//:aho_corasick",
        "@raze__memchr__2_0_1//:memchr",
        "@raze__regex_syntax__0_6_0//:regex_syntax",
        "@raze__thread_local__0_3_5//:thread_local",
        "@raze__utf8_ranges__1_0_0//:utf8_ranges",
    ],
    rustc_flags = [
        "--cap-lints allow",
