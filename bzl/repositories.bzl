...
REPOSITORIES = {
    ...
    "zlib": {
        ...
        "tag": "v1.2.8",
        "build_file": str(Label("//bzl:build_file/com_github_madler_zlib.BUILD")),
    },
    ...
    "com_github_golang_glog": {
        ...
        "build_file": str(Label("//bzl:build_file/com_github_golang_glog.BUILD")),
    },
    ...
    "org_golang_google_grpc": {
        ...
        "tag": "v1.0.0",
        "build_file": str(Label("//bzl:build_file/org_golang_google_grpc.BUILD")),
    },
